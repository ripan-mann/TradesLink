            ...
            <div class="col-md-12 col-lg-12 ml-5">
                <div class="row mb-5">
                    <div class="col-md-12 col-lg-12 mt-2">
                        <h1><label class="text-dark" for="business_name">Welcome to&nbsp;&nbsp; <span class="font-weight-bold text-primary"> <?php echo h($provider['business_name']) ?> </span></label></h1>
                    </div>
                </div>
                ...
                <div class="row form-group mt-5">
                    ...
                    <div class="col-md-12 col-lg-2">
                        <?php if (!isset($_SESSION['provider_id'])) {
                            if (!$booking) {
                        ?>
                                <a href="<?php echo url_for('/booking/pick_date.php?id=' . h(u($id))); ?>" class="btn btn-primary  py-2 px-5">Make an Appointment</a>
                            <?php } else{?>
                                <a href="<?php echo url_for('/booking/show_booking_user.php'); ?>" class="btn btn-success  py-2 px-5">Show Appointment</a>
