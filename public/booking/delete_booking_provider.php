...
if (is_post_request()) {
    ...
    redirect_to(url_for('/booking/show_booking_provider.php'));
} else {
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-12 col-lg-12">
                    <form action="<?php echo url_for('/booking/delete_booking_provider.php?id=' . h(u($id))); ?>" method="post">
                        ...
                        <div class="row form-group h4">
                            ...
                            <div class="col-md-4 col-lg-4 mb-2">
                                <label class="font-weight-bold text-primary" for="phone_number"><?php echo h($user['first_name']) ?></label>
                            </div>
                        </div>
